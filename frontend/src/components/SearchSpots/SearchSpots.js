                    ...
                    { spotsByTag.spots && spotsByTag?.spots.map((e) =>
                        <Link to={`/spot/${e.id}`} onMouseOver={()=> dispatch(dispatchCoordinates({ "X": e.coordinateX, "Y": e.coordinateY })) } key={e.id}>
                            <div id={`list-${e.id}`} className="list">
                                ...
                                <div className="mainPicBackground" style={{backgroundImage: `url(${e.mainPic})`}}></div>
                                <div className="mainPicForeground" style={{backgroundImage: `url(${e.mainPic})`}}></div>
                                </div>
                                ...
                                <div className="spotContent">
                                    <div className="top">
                                        ...
                                        <div className="description"><p>{e.description}</p></div>
                                    </div>

                                    <div className="bottom">
                                        <div>
                                            <img src='/images/redStar.png' style={{ width: '15px' }} alt="rating star"></img>
                                                &nbsp; {e?.Reviews && average(e.Reviews)}</div>
                                        <div>{e.price} gp / night</div>
                                    </div>
                                </div>
